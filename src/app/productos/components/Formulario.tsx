...
import { ProductoSchema } from '../productos.zod'
import { editarProductoAPI, guardarProductoAPI } from '../api/productos.api'
...
const Formulario = ({ handleClose }: FormularioProps) => {
    ...
    const { productos, setProductos, producto, setProducto, editando, obtenerUnidadesMedida, unidadesMedida } = useContext(ProductosContext)
